...
<head>
    ...
    <?php if(is_page(637)):?>
        <script async src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAcCZ4mj6l487UULbiFxsPHEUzkQUIuy-A&callback=console.debug&libraries=maps,marker&v=beta"></script>
    <?php endif;?>
