<div class="header navigation">
    <div class="col-g">
        <a href="<?php echo home_url();?>">
            ...
            if($logo):?><img src="<?php echo $logo['url'];?>" alt="<?php echo $logo['title'];?>" class="logo" /><?php endif;?>
        </a>
    </div>
    <div class="col-d">
        ...
        <div class="hamburger-menu">
            <svg id="open_the_Mmenu" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10" stroke-width=".6"
                ...
                <rect width="10" height="10" stroke="none"><animate dur="2s" id="reverse" attributeName="width" begin="click" /></rect>
